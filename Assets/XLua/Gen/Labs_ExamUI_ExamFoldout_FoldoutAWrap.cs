...
namespace XLua.CSObjectWrap
{
    ...
    public class LabsExamUIExamFoldoutFoldoutAWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Labs.ExamUI.ExamFoldout.FoldoutA);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UssName", Labs.ExamUI.ExamFoldout.FoldoutA.UssName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "IconUssName", Labs.ExamUI.ExamFoldout.FoldoutA.IconUssName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "IconOnUssName", Labs.ExamUI.ExamFoldout.FoldoutA.IconOnUssName);
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "IconOffUssName", Labs.ExamUI.ExamFoldout.FoldoutA.IconOffUssName);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Labs.ExamUI.ExamFoldout.FoldoutA();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Labs.ExamUI.ExamFoldout.FoldoutA constructor!");
        ...
        static int _m_SetValue(RealStatePtr L)
        {
		    try {
                ...
                Labs.ExamUI.ExamFoldout.FoldoutA gen_to_be_invoked = (Labs.ExamUI.ExamFoldout.FoldoutA)translator.FastGetCSObj(L, 1);
