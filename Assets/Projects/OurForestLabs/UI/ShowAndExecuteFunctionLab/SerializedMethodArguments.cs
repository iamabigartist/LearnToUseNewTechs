...
namespace UI.ShowAndExecuteFunctionLab
{
	...
	public class MethodArgumentsContainerDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			EditorGUI.LabelField(position.GetGridPart(1, args_count + 2, 0, 0), label);
			EditorGUI.Popup(
					position.GetGridPart(1, args_count + 2, 0, 1),
			...
			DrawGridUIs(position.GetGridPart(
					1, args_count + 2,
	...
	public class MethodArgumentsContainer
	{
		...
		public int Option
		{
			...
			set
			{
				...
				{
					option = value;
					method_arguments = new(method_list[option]);
				}
			}
		}
		...
		public MethodArgumentsContainer(MethodInfo[] method_list)
		{
			...
			method_arguments = new(method_list[1]);
		}
	}
